...
/**
 * Starts and handles web auth activity.
 *  
 * @author Jeramie Risinger jeramie.risinger@gmail.com, jeramie@flicka.mobi
 * @date 2010.01.12
 */
public class ActivityWebAuth extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Utilities.errorOccurred(this, "Unable to load auth url.", e);
		}                     
    }
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        /**
         * by doing this, we at least know the user did something
         * so, on the first call of this, enable the return button, 
         * decided not to disable cancel.  what if they don't click the ok button?
         * 
         */
