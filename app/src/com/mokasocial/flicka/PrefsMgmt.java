...
/**
 * This class manages preferences and can be called to get or set them. Remember to 
 * override onStop and call savePreferences. All preferences should be restored, set,
 * get, and saved within this object.
 * 
...
public class PrefsMgmt {
    ...
    public void savePreferences() {
        ...
        Utilities.debugLog(this, commitResult + " SharedPreferences");
    }
	...
	/**
	 * Whether or not we should be automatically loading 
	 * more photos at the bottom of a stream.
	 * 
	 * @return boolean
	 */
