...
public class ContactsInterface {
     ...
     * @throws SAXException
     */
    public Collection getList(int perPage, int page) throws IOException, SAXException, FlickrException {
        ...
        String key = "ContactsInterface_" + parameters.hashCode();
        ...
        for (int i = 0; i < contactNodes.getLength(); i++) {
            ...
            String temp = contactElement.getAttribute("photos_uploaded");
            if(temp != null && temp != "") {
            	contact.setPhotosUploaded(temp);
            }
