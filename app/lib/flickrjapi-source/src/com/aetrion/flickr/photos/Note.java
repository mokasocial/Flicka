...
import com.aetrion.flickr.photos.RectangleCustom;
...
public class Note {
    ...
    private RectangleCustom bounds;
    private String text;
    ...
    public RectangleCustom getBounds() {
        return bounds;
    }

    public void setBounds(RectangleCustom bounds) {
        this.bounds = bounds;
    }
    ...
    public void setBounds(String x, String y, String w, String h) {
        ...
        setBounds(new RectangleCustom(xi, yi, wi, hi));
    }
