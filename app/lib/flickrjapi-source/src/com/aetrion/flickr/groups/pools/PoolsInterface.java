...
public class PoolsInterface {
     ...
     *
     * @param int Per page value. Less than 1 is ignored.
     * @param int Page value. Less than 1 is ignored.
     * @return A Collection of Group objects
     * @throws IOException
     * @throws SAXException
     * @throws FlickrException
     */
    public Collection getGroups(int perPage, int page) throws IOException, SAXException, FlickrException {
        ...
        String key = "PoolsInterface_" + parameters.hashCode();
        Response response = this.flickrCache.get(key);
        
        if(response == null) {
        	response = transport.get(transport.getPath(), parameters);
        ...
        for (int i = 0; i < groupNodes.getLength(); i++) {
            ...
            group.setPhotoCount(new Integer(groupElement.getAttribute("photos")));
